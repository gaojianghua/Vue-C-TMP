; (function () {
    ...
    n.initDOM = function () {
        var n = function (n, t) {
            ...
            y = n('div', 'sliderbg'),
            s = n('div', 'slider'),
            a = n('i', 'iconfont icon-arrow-right sliderIcon'),
            h = n('span', 'sliderText'),
            u,
            c
        e.className = 'slider-captcha-block'
            ...
            s = function (u) {
                ...
                e.spliced && e.verified
                    ? (n.sliderContainer.classList.add('sliderContainer_success'),
                        i(n.options.onSuccess) && n.options.onSuccess.call(n.$element, f))
