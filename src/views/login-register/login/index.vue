        ...
        <div
            ...
            <vee-form @submit="onLoginHandler">
                ...
                <div class="pt-1 pb-3 leading-[0px] text-right">
                    <a @click="onToRegister"
                        class=" inline-block p-1 text-zinc-400 text-right dark:text-zinc-600 dark:hover:text-zinc-400 text-sm duration-300 cursor-pointer">去注册</a>
                </div>
                <!-- 登录按钮 -->
            ...
            <div class="flex justify-around mt-4">
                <!-- QQ -->
                <g-svg-icon class="w-4 cursor-pointer" name="qq"></g-svg-icon>
                <!-- 微信 -->
